...
export default function CartPage() {
  ...
  // chỉ lưu những item mà user đã toggle
  ...
  return (
    <div className="px-4 py-10 md:px-6">
      ...
      <div className="mb-6 flex items-center gap-2 text-sm text-slate-500">
        ...
        <span>/</span>
        <span className="font-medium text-slate-700">Your Cart</span>
      </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-1 items-center gap-3">
                  ...
                  <Link
                    href={`/products/${id}`}
                    className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-slate-100 bg-slate-50"
                  >
                    <Image
                  ...
                  <div className="min-w-0 flex-1 text-sm">
                    <Link
                      href={`/products/${id}`}
                      className="line-clamp-2 font-semibold text-slate-900 transition hover:text-sky-600"
                    >
                      {item.product.name}
                    </Link>
                ...
                {/* RIGHT: mobile = column, desktop = 4-column grid */}
                <div className="mt-1 w-full text-sm md:mt-0 md:w-[480px] md:grid md:grid-cols-[110px_140px_120px_60px] md:items-center md:gap-4">
                  ...
                  <div className="flex items-center justify-between md:block">
                    ...
                    <div className="whitespace-nowrap text-slate-700 md:text-right">
                  ...
                  <div className="mt-2 flex items-center justify-between md:mt-0 md:justify-center">
                    <span className="mr-3 text-xs text-slate-400 md:hidden">
                      Quantity
                    </span>
                  ...
                  <div className="mt-2 flex items-center justify-between md:mt-0 md:block">
                    ...
                    <div className="whitespace-nowrap font-semibold text-slate-900 md:text-right">
                  ...
                  <div className="mt-2 flex justify-end md:mt-0">
                    <button
                      className="inline-flex items-center gap-1 cursor-pointer text-xs font-medium text-rose-500 hover:text-rose-600"
          ...
          <div className="mx-auto flex max-w-5xl flex-col items-center gap-4 text-sm md:flex-row md:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-4 md:gap-6">
              <div className="text-right text-sm">
                ...
                <div className="whitespace-nowrap text-lg font-bold text-emerald-600">
